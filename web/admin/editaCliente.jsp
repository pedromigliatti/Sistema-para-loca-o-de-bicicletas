...
return true
    ...
    <body>
        <sec:authorize access="hasRole('ADMIN')">
                <form name="frm" action="atualizaCliente">
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="senha" name="senha" type="password" placeholder="senha" class="form-control input-md" required="" value="${cliente.senha}" onclick="return ValidateEmail()">
